...
![](<https://static001.geekbang.org/resource/image/5b/70/5bf8eaed00a822a67c43666b44494b70.jpg>)

<audio><source src="https://static001.geekbang.org/resource/audio/1e/fc/1e5f7703bd5ef647cb041a7f8e2398fc.mp3" type="audio/mpeg"></audio>
...
<center><span class="reference">图1 InheritedWidget使用方法</span></center>
...
<center><span class="reference">图2 InheritedWidget数据修改示例</span></center>
...
<center><span class="reference">图3 自定义Notification</span></center>
...
<center><span class="reference">图4 EventBus示例</span></center>
...
<center><span class="reference">图5 属性传值、InheritedWidget、Notification与EventBus数据传递方式对比</span></center>
