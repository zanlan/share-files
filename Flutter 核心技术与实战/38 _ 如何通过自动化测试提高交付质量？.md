...
![](<https://static001.geekbang.org/resource/image/3d/6d/3d0f75656607584fe52f32da4c9c716d.jpg>)

<audio><source src="https://static001.geekbang.org/resource/audio/9a/8e/9a5c2d4cc971ae10841ca25b2096f88e.mp3" type="audio/mpeg"></audio>
...
<center><span class="reference">图1 Flutter工程目录结构</span></center>
...
<center><span class="reference">图2 启动测试用例入口</span></center>
...
<center><span class="reference">图3 单元测试失败示意图</span></center>
...
<center><span class="reference">图4 计数器示例</span></center>
