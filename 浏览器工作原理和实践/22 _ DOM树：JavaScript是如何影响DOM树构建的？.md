...
![](<https://static001.geekbang.org/resource/image/03/b4/03d4b082f8894a2781567c510970a3b4.jpg>)

<audio><source src="https://static001.geekbang.org/resource/audio/ff/d5/ff2e8f210ed4ade39f5b72902e3c40d5.mp3" type="audio/mpeg"></audio>
...
<center><span class="reference">字节流转换为DOM</span></center>
...
<center><span class="reference">生成的Token示意图</span></center>
...
<center><span class="reference">解析到StartTag html时的状态</span></center>
...
<center><span class="reference">解析到StartTag div时的状态</span></center>
...
<center><span class="reference">解析出第一个文本Token时的状态</span></center>
...
<center><span class="reference">执行脚本时DOM的状态</span></center>
