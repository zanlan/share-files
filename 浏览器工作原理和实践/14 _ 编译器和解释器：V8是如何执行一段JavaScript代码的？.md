...
![](<https://static001.geekbang.org/resource/image/b8/d7/b80f6e4f8ee405c4687ccf09c90e09d7.jpg>)

<audio><source src="https://static001.geekbang.org/resource/audio/35/14/35938306cf47de1be279360ca97a5a14.mp3" type="audio/mpeg"></audio>
...
<center><span class="reference">编译器和解释器“翻译”代码</span></center>
...
<center><span class="reference">V8执行一段代码流程图</span></center>
...
<center><span class="reference">抽象语法树（AST）结构</span></center>
...
<center><span class="reference">分解token示意图</span></center>
...
<center><span class="reference">字节码和机器码占用空间对比</span></center>
...
<center><span class="reference">即时编译（JIT）技术</span></center>
