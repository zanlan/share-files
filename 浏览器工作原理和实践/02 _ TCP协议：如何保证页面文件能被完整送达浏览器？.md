...
<audio><source src="https://static001.geekbang.org/resource/audio/98/ab/989fd02dfaccd7c08555afd3ee2138ab.mp3" type="audio/mpeg"></audio>
...
<center><span class="reference">简化的IP网络三层传输模型</span></center>
...
<center><span class="reference">简化的UDP网络四层传输模型</span></center>
...
<center><span class="reference">简化的TCP网络四层传输模型</span></center>
...
<center><span class="reference">一个TCP连接的生命周期</span></center>
