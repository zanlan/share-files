...
<audio><source src="https://static001.geekbang.org/resource/audio/3d/8d/3d4d948d10d7b1dbe4e9add4e29a538d.mp3" type="audio/mpeg"></audio>
...
<center><span class="reference">从输入URL到页面展示完整流程示意图</span></center>
...
<center><span class="reference">开始加载URL浏览器状态</span></center>
...
<center><span class="reference">响应行返回状态码301</span></center>
...
<center><span class="reference">响应行返回状态码200</span></center>
...
<center><span class="reference">含有HTML格式的Content-Type</span></center>
...
<center><span class="reference">含有stream格式的Content-Type</span></center>
...
<center><span class="reference">多个页面运行在一个渲染进程中</span></center>
...
<center><span class="reference">非同一站点使用不同的渲染进程</span></center>
...
<center><span class="reference">导航完成状态</span></center>
...
<center><span class="reference">渲染结束</span></center>
