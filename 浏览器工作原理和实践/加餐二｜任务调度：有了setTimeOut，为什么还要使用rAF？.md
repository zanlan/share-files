...
![](<https://static001.geekbang.org/resource/image/d1/f4/d187bb34aa16d45e21821c6867d119f4.jpg>)

<audio><source src="https://static001.geekbang.org/resource/audio/36/c0/36bb3a194534a23f6e9e5b3f7d0003c0.mp3" type="audio/mpeg"></audio>
...
<center><span class="reference">任务和消息队列</span></center>
...
<center><span class="reference">队头阻塞问题</span></center>
...
<center><span class="reference">引入高优先级的消息队列</span></center>
...
<center><span class="reference">增加多个不同优先级的消息队列</span></center>
...
<center><span class="reference">根据消息类型实现不同优先级的消息队列</span></center>
...
<center><span class="reference">动态调度策略</span></center>
...
<center><span class="reference">VSync时钟周期和渲染引擎生成图片不同步问题</span></center>
...
<center><span class="reference">绑定VSync时钟同步周期和浏览器生成页面周期</span></center>
