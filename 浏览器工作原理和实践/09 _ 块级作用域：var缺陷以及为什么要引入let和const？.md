...
![](<https://static001.geekbang.org/resource/image/33/d5/330cd04fbacbab5413868e15858fbcd5.jpg>)

<audio><source src="https://static001.geekbang.org/resource/audio/29/57/291ed6110131ffb0967491d7b2031757.mp3" type="audio/mpeg"></audio>
...
<center><span class="reference">开始执行showName函数时的调用栈</span></center>
...
<center><span class="reference">varTest函数的执行上下文</span></center>
...
<center><span class="reference">刚执行时foo函数的执行上下文</span></center>
...
<center><span class="reference">执行foo函数内部作用域块时的执行上下文</span></center>
...
<center><span class="reference">变量查找过程</span></center>
...
<center><span class="reference">作用域执行完成示意图</span></center>
