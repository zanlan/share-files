...
![](<https://static001.geekbang.org/resource/image/11/78/118429605c6b8944e2b45200ab3f4a78.jpg>)

<audio><source src="https://static001.geekbang.org/resource/audio/04/5c/04646c9d26ec6b3dd4256cb3cbaf895c.mp3" type="audio/mpeg"></audio>
...
<center><span class="reference">语言类型图</span></center>
...
<center><span class="reference">JavaScript内存模型</span></center>
...
<center><span class="reference">执行到第3行时的调用栈状态图</span></center>
...
<center><span class="reference">对象类型是“堆”来存储</span></center>
...
<center><span class="reference">调用栈中切换执行上下文状态</span></center>
...
<center><span class="reference">引用赋值</span></center>
